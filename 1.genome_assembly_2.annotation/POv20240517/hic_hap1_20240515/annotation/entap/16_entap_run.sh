...
ln -s ../gemoma/PO_male_hap1.v20240517.protein.fasta ./
...
~/software/EnTAP-1.0.1/EnTAP --runP -i ./PO_male_hap1.v20240517.protein.fasta -d /home/yo/db/entap_DB/bin/vertebrate_other.dmnd -d /home/yo/db/entap_DB/bin/uniprot_sprot.dmnd -d /home/yo/db/entap_DB/bin/uniprot_trembl.dmnd -t 20 --ini /home/yo/software/EnTAP-1.0.1/entap_config.ini
