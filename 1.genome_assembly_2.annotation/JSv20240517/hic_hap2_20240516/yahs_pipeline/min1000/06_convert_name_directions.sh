...
REF=JS_male_DC_OmniCtrimmed.enzymemix.hic.hap2.yahs.min1000_JBAT.FINAL.fa
CONVERT_TABLE=scaffold_directions.txt
OUT_HEADER=JS_male_DC_OmniCtrimmed.enzymemix.hic.hap2.yahs.min1000_JBAT.FINAL.rename
OUTDIR=renamed
