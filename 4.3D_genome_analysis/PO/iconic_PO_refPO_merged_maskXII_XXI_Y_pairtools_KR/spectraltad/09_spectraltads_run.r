...
PREFIX <-"iconic_PO_refPO_merged_maskXII_XXI_Y_pairtools_spectraltad"
...
for(j in 1:length(BIN)){
  ...
  contact <- read_tsv(paste0("../hic/binned/iconic_PO_refPO_merged_maskXII_XXI_Y_pairtools_", BIN_tmp, ".txt"), 
  ...
  for(i in CHR){
    ...
    contact_chr$chr1_start <- contact_chr$chr1_start - 1
    contact_chr$chr2_start <- contact_chr$chr2_start - 1
