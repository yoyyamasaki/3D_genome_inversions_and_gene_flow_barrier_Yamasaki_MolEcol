...
DIR=../fastq/filtered
REF=~/db/JS_male_merged_mask_chrXII_chrXXI_chrYXI_20240517/
GTF=${REF}/JS_male_merged.v20240517.mod.maskXII_XXI_Y.gtf
...
--sjdbGTFfile ${GTF} --readFilesCommand zcat --runThreadN 10 --outSAMtype BAM SortedByCoordinate \
