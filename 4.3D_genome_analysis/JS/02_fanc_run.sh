...
HEADER=iconhic_JS_refJS_merged_maskXII_XXI_Y_pairtools
NORM_METHOD=KR
THREAD=48
...
for i in 10kb 25kb 50kb 100kb 250kb 500kb 1mb 2mb 5mb;do
	...
	BIN=${i}
        fanc dump --uncorrected --only-intra ${HEADER}_${NORM_METHOD}/hic/binned/${HEADER}_${BIN}.hic ${HEADER}_${NORM_METHOD}/hic/binned/${HEADER}_${BIN}.txt
done
