...
write_tsv(inversion_25kb_breakpoints_merged, "./syri20240917_PO_JS_asm5syri.25kb.INV_breakpoint.bed")
...
write_tsv(inversion_AB_distance, "./inversion_PO_JS_asm5_AB_PO_dist.txt")
write_tsv(AB_overlap, "./inversion_asm5_overlapped_AB_PO.txt")
...
inversion_AB_distance_hist <- hist(inversion_AB_distance_longer_orthologous$N_bin, plot = F, breaks = seq(0, 85))
...
ggsave("INV_AB_distans_bin_PO.eps", INV_AB_dist_hist, width =5, height = 5)
...
write_tsv(inversion_AB_distance_all, "./inversion_PO_JS_asm5_AB_PO_dist_all.txt")
write_tsv(AB_overlap_all, "./inversion_asm5_overlapped_AB_PO_all.txt")
...
inversion_AB_distance_all_hist <- hist(inversion_AB_distance_longer_all$N_bin, plot = F, breaks = seq(0, 83))
...
ggsave("INV_AB_distans_bin_PO_JS_all.eps", INV_AB_dist_all_hist, width =5, height = 5)
